 ...
 *
 */
public abstract class BaseEntityMailService<T extends BaseEntity> implements MailEntityApiService<T> {
	 ...
	 */
	public BaseEntityMailService() throws MessagingException {
	 ...
	 */
	@Override
	public void send(final IMailTO<T, Long> source, final boolean html) throws CoreApiFrameworkMailException {
		if (validate(source)) {
	 ...
	 */
	@Override
	public void setFrom(final IMailTO<T, Long> source) throws MessagingException {
	 ...
	 */
	@Override
	public void setSubject(final IMailTO<T, Long> source) throws MessagingException {
	 ...
	 */
	@Override
	public void setText(final IMailTO<T, Long> source, final boolean html) throws MessagingException {
	 ...
	 */
	@Override
	public void setTo(final IMailTO<T, Long> source) throws MessagingException {
	 ...
	 * @return boolean
	 */
	protected boolean validate(final IMailTO<T, Long> source) {
