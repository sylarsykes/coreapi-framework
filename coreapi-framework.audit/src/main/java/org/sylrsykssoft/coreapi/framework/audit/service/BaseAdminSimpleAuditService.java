 ...
 */
public abstract class BaseAdminSimpleAuditService<T extends BaseAdminSimpleAudit, R extends BaseAdminSimpleAuditResource>
extends BaseAdminSimpleService<T, R> implements IAdminSimpleAuditService<T, R, Integer, Integer> {
	 ...
	 */
	@Override
	public abstract BaseAdminSimpleAuditRepository<T> getAdminRepository();
