...
/**
 * IFindRevisionAdminAuditService define services for find revisions of entities
 * BaseAdminSimple.
 * 
 ...
 */
public interface IFindRevisionAdminAuditService<T extends BaseAdmin, R extends BaseAdminResource, I extends Number, N extends Number & Comparable<N>> {
	 ...
	 * @return the {@link Revision} of the entity with the given ID in the given
	 *         revision number.
	 */
	...
	/**
	 * Returns a {@link Page} of revisions for the entity with the given id. Note,
	 * that it's not guaranteed that implementations have to support sorting by all
	 * properties.
	 *
	 * @param id       must not be {@literal null}.
	 * @param pageable
